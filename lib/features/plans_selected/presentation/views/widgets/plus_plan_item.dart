...
class PlusPlanItem extends StatelessWidget {
  const PlusPlanItem({super.key});
      ...
      children: [
        CustomPlanContainer(
          child: Column(
            spacing: 12,
            children: [
              PlanHeader(title: 'بلس'),

              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  SvgPicture.asset(Assets.numberOfViews18Icon),
                  Spacer(),
                  Column(
        ...
        Positioned(
          top: -20,
          right: 0,
          child: PlanOfferBadge(title: 'افضل قيمة مقابل سعر'),
        ),
      ],
    );
  }
